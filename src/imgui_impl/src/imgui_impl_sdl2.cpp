...
// Functions
static char const* ImGui_ImplSDL2_GetClipboardText(void*)
{
...
static void ImGui_ImplSDL2_SetClipboardText(void*, char const* text)
{
...
static bool ImGui_ImplSDL2_Init(SDL_Window* window, SDL_Renderer* renderer)
{
    ...
    char const* sdl_backend = SDL_GetCurrentVideoDriver();
    char const* global_mouse_whitelist[] = {"windows",
        "cocoa",
        "x11",
        "DIVE",
        "VMAN"};
...
static void ImGui_ImplSDL2_UpdateMouseData()
{
    ...
    bool const is_app_focused = (bd->Window == focused_window);
#else
    bool const is_app_focused =
